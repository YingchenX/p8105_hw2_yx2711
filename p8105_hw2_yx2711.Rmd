...
Import `Trash Wheel Collection Data` and clean names. 
Use `select()` to select dumpster-specific data and `as.integer()`to convert the number of sports balls to integer.
```{r}
trash_wheel = read_xlsx("C:/Users/Carolinexyc/OneDrive/Desktop/P8105/p8105_hw2_yx2711/Trash Wheel Collection Data.xlsx", sheet = 1) %>% 
  janitor::clean_names() %>% 
